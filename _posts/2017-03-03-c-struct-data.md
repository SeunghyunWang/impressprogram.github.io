...
지난 포스팅에서 토크나이징을 이용해서 자연스럽게 명령어를 처리하도록 하였습니다.  
이번 포스팅에서는 구조체를 이용하여 전화번호부에 데이터를 좀 더 저장해보겠습니다.  
구조체는 아래와 같이 쓰입니다.
...
이렇게 위와같이 여러 변수들을 저장해서 나만의 변수집합을 만들 수 있는 것이 포인트입니다.  
아래는 이전 포스팅을 구조체를 이용해서 개선시킨 전화번호부입니다.
